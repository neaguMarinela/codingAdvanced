...
public class Parallel {
    public static void main(String[] args){
        ...
        System.out.println("the number of evens: "+counted
                + " time for execution: "+duration + " millis");
        ...
        System.out.println("the number of evens: "+count
                + " time for execution: "+durationSecond + " millis");
    }
}
