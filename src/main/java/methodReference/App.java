...
public class App
{
    public static void main( String[] args )
    {
        ...
        Arrays.sort(name, Comparator.comparing(App::firstName).reversed().thenComparing(App::title));

        System.out.println("Names and title: " + Arrays.toString(name));
    }

    public static String firstName(String name) {
        System.out.println("Name: " + name);
        System.out.println("Split name, first elem: " + name.split(" ")[0]);
        System.out.println("Split name, second elem: " + name.split(" ")[1]);
        return name.split(" ")[1];
    }
